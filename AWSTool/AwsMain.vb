...
rechek:
    ...
    Private Sub lnkAddtoWatch_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkAddtoWatch.LinkClicked
        setInWatchList(True)
    End Sub

    Private Sub lnkRemovWatch_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkRemovWatch.LinkClicked

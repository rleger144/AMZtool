...
namespace AmazonMWS1
{
    ...
    public class MarketplaceWebServiceProductsException : Exception 
    {
        ...
        public MarketplaceWebServiceProductsException(String message, HttpStatusCode statusCode, ResponseHeaderMetadata rhm) : this (message)
        {
        ...
        /// <param name="message">Overview of error</param>
        /// <param name="t">Wrapped exception</param>
        public MarketplaceWebServiceProductsException(String message, Exception t) : base (message, t) {
            this.message = message;
        ...
        public MarketplaceWebServiceProductsException(String message, HttpStatusCode statusCode, String errorCode, String errorType, String requestId, String xml, ResponseHeaderMetadata rhm) : this (message, statusCode, rhm)
        {
